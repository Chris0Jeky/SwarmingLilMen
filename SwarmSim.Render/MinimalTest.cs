    ...
    private static SimConfig CreateConfigForStage(int stage)
    {
        ...
        return stage switch
        {
            0 or 1 => new SimConfig // No forces or manual force
            {
                ...
                MaxSpeed = 10f,
                Friction = 1f,  // FIXED: Was 0.99 (too high!)
                SeparationWeight = 0f,
                AlignmentWeight = 0f,
                CohesionWeight = 0f,
            ...
            2 or 3 => new SimConfig // Separation only
            {
                ...
                FixedDeltaTime = 1f / 60f,
                MaxSpeed = 10f,
                Friction = 1f,  // FIXED: Was 0.99
                SeparationWeight = 5.0f,  // FIXED: Was 1.0 (5x stronger)
                AlignmentWeight = 0f,
                CohesionWeight = 0f,
                SeparationRadius = 30f,
                SenseRadius = 100f,
            ...
            4 => new SimConfig // Alignment only
            {
                ...
                Friction = 1f,  // FIXED: Was 0.99
                SeparationWeight = 0f,
                AlignmentWeight = 5.0f,  // FIXED: Was 1.0 (5x stronger)
                CohesionWeight = 0f,
                SeparationRadius = 30f,
                SenseRadius = 100f,
                AttackDamage = 0f,
            ...
            5 => new SimConfig // Cohesion only
            {
                ...
                SeparationWeight = 0f,
                AlignmentWeight = 0f,
                CohesionWeight = 1.0f,  // FIXED: Was 0.1 (10x stronger)
                SeparationRadius = 30f,
                SenseRadius = 100f,
                AttackDamage = 0f,
                BaseDrain = 0f
            ...
            _ => new SimConfig // All forces (stages 6-8)
            {
                ...
                Friction = 1f,  // FIXED: Was 0.99
                SeparationWeight = 5.0f,  // FIXED: Was 1.0 (5x stronger)
                AlignmentWeight = 2.5f,  // FIXED: Was 0.5 (5x stronger)
                CohesionWeight = 0.5f,  // FIXED: Was 0.1 (5x stronger)
                SeparationRadius = 30f,
                SenseRadius = 100f,
                AttackDamage = 0f,
                BaseDrain = 0f
