...
- Performance-category tests are excluded from the default CI suite. When run explicitly, all four
  ...
  objective.
- CI-filtered coverage report (`XPlat Code Coverage`, Release, `Category!=Performance`): **57.46%
  line / 39.20% branch overall**; `SwarmSim.Core` is 83.59% line / 72.16% branch and
